...
public class HomeController {
    ...
    public String frontHome() { return "FrontSample"; }

    @RequestMapping(value = "/jusoPopup")
    public String jusoPopup() { return "jusoPopup"; }


    // 서버단 처리(JSON)
    @RequestMapping(value = "/back")
    public String backHome() { return "BackSample"; }
    ...
    public String backXmlHome() { return "BackSampleXml"; }
    ...
    public String frontXmlHome() { return "FrontSampleXml"; }
    ...
    public String backXmlBack() { return "BackSampleXmlJsp"; };
    ...
    public void getAddrApiXmlJsp (HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        doc.getDocumentElement().normalize();
        // root(최상위) tag 찾기
        log.info(doc.getDocumentElement().getNodeName());   // results

        // 파싱할 tag = <juso>
        // nList에 <juso>태크가 하나씩 담기게 되고 nList.getLenght()를 통해 리스트의 수를 확인할 수 있다.
        NodeList nList = doc.getElementsByTagName("juso");
        log.info("nList : " + nList);
        log.info("nList.getLength : " + nList.getLength());

//        Node nNode = nList.item(1);
//        Element eElement = (Element) nNode;
//        log.info("nNode : " + nNode);
//        log.info("eElement : " + eElement.getTextContent());
...
//        File file = new File("/WEB-INF/BackSample.jsp");
//        String filePath = file.getAbsolutePath();
        String filePath = "C:\\Users\\장현아\\Desktop\\openApi\\src\\main\\webapp\\WEB-INF\\views\\sendFile.jsp";
        String outFilePath = "C:\\Users\\장현아\\Desktop\\openApi\\src\\main\\webapp\\WEB-INF\\views\\outFile.jsp";
        String outText = "";
//        try {
...
//        }
        ...
        try {
            BufferedWriter bfWrite = new BufferedWriter(new FileWriter(outFilePath));
